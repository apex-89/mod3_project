...
let connectionString = `mongodb+srv://${process.env.MONGOUSERNAME}:${process.env.MONGOPASSWORD}@mongosetupcluster.1eeko3p.mongodb.net/Todo?retryWrites=true&w=majority`;
